...
$result = $conn->query("SELECT * FROM ads where  date(created_at)=date('$date') and type='1'  LIMIT 1");
//  print_r($result);die;
...
//print_r($row);die;
    ...
    $sql = "UPDATE visitors SET count_visit=$visitor_count WHERE date(created_at)=date('$date') and type='1' ";
    ...
    $sql = "INSERT INTO visitors (count_visit,type )
        ...
        <div class="iconss text-center">
            <div class="container">
                ...
                <a href="https://www.instagram.com/majestic.estate/?igshid=ZWQyN2ExYTkwZQ%3D%3D"
                    class="btn btn-info btn-lg iconin"> <i class="fa fa-instagram fa-fw " onclick="count_insta();"
                        oncontextmenu="count_insta();"></i> تابعنا على انستغرام </a>
