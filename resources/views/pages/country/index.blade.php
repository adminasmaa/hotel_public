                            ...
                            <div class="tab-pane fade active show" id="countries" role="tabpanel"
                                ...
                                <div class="card mb-0">
                                    <div class="card-header d-flex">
                                        ...
                                        <div class="modal fade modal-bookmark" id="countriesModal" tabindex="-1"
                                             role="dialog" aria-labelledby="countriesModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="countriesModalLabel">بلد
                                                            جديد </h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="mb-3 mt-0 col-md-6">
                                                                    <label for="task-title">
                                                                        ...
                                                                        اسم البلد<span class=" text-danger">*</span></label>
                                            ...
                                            <table class=" table display  data-table-responsive " id="">
                                                ...
                                                @foreach($countries as $country)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$country->name}}</td>
                                                        <td><a
                                                                href="{{route('products.index',array('country' => $country->id))}}">{{$country->count}}</a>
                                                        </td>
                                                        <td>
                                                            @role('countries.update')
                                                            <a class="me-2" data-bs-toggle="modal"
                                                               href="{{('/#editModal'.$country->id)}}"><i
                                                                    data-toggle="modal"
                                                                    data-target="#editModal{{$country->id}}"
                                                                    data-feather="edit" width="15" height='15'></i></a>
                                                            @endrole
                                                            @role('countries.destroy')
                                                        ...
                                                        <div class="modal fade modal-bookmark"
                                                             id="editModal{{$country->id}}" tabindex="-1" role="dialog"
                                                                        ...
                                                                        <form class="form-bookmark needs-validation"
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-3 mt-0 col-md-6">
                                                                                    ...
                                                                                    <input class="form-control" value="{{$country->name_en}}" name="name_en" id="name_en"
                                                                                ...
                                                                                <div class="mb-3 mt-0 col-md-6">
                                                                                    <label for="task-title">كود
                                                                                        البلد </label>
                                                                                    <input class="form-control" name="code" id="code"
                                                                                           type="text" value="{{$country->code}}" autocomplete="off">
                                                                                    @error('code')
                                                                                    <div style='color:red'>{{$message}}</div>
                                                                                    @enderror
                                                                                </div>
                                                                                ...
                                                                                <div class="mb-3 mt-0 col-md-6">
                                                                                    <label for="task-title">رمز
                                                                                        البلد </label>
                                                                                    <input class="form-control" value="{{$country->abbr}}" name="abbr" id="abbr"
                                                                                           type="text" autocomplete="off">
                                                                                    @error('abbr')
                                                                                    <div style='color:red'>{{$message}}</div>
                                                                                    @enderror
