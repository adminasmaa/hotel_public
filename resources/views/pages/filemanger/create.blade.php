    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                <form class="mega-vertical" action="{{route('filesmanger.store')}}" method="post"
                                ...
                                <div class="row">
                                    @if(!Session::has('branch'))
                                                ...
                                                <div class="col-sm-11">
                                                    <select name='branch_id' class="form-select"
                                                        ...
                                                        @foreach($branches as $branche)
                                                            <option
                                                                value='{{$branche->id}}'{{old('branch_id') == $branche->id ?'selected':''}}>{{$branche->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('branch_id')
                                                    <div style='color:red'>{{$message}}</div>
                                        ...
                                        <div class="mb-3 mt-0 col-md-4">
                                            ...
                                            <input class="form-control" name="expired_date" id="expired_date"
                                                   type="date"
                                                   autocomplete="off">
                                            @error('expired_date')
                                            <div style='color:red'>{{$message}}</div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-11">
                                                        <select name='branch_id' class="form-select"
                                                            ...
                                                            @foreach($branches as $branche)
                                                                <option
                                                                    value='{{$branche->id}}'{{$branche->branch_id == $branche->id ?'selected':''}}>{{$branche->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('branch_id')
                                                        <div style='color:red'>{{$message}}</div>
                                            ...
                                            <div class="col-sm-11">
                                                <select name='file_dept_id' class="form-select"
                                                    ...
                                                    @foreach($files_depts as $files_dept)
                                                        <option
                                                            value='{{$files_dept->id}}'>{{$files_dept->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('file_dept_id')
                                                <div style='color:red'>{{$message}}</div>
                                    ...
                                    <div class="mb-3 mt-0 col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-11">
                                                <select name='file_type_id' id="file_type_id" class="form-select"
                                                        aria-label="Default select example">
                                                    <option value=''> اخنر نوع الملف</option>
                                                    @foreach($files_types as $files_type)
                                                        <option
                                                            value='{{ $files_type->id }}'>{{$files_type->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('file_type_id')
                                                <div style='color:red'>{{$message}}</div>
