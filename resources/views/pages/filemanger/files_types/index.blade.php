                                    ...
                                    <div class="card-header d-flex">
                                        <h5 class="mb-0">
                                            ...
                                            <button class="me-2 btn-block btn-mail w-100" data-bs-toggle="modal"
                                                    data-bs-target="#fileTypeModal" type="button"
                                        ...
                                        <div class="dt-ext table-responsive">
                                            <table class=" table display  data-table-responsive " id="">
                                                ...
                                                @foreach($files_types as $files_type)
                                                    ...
                                                    <tr>
                                                        <td>{{$count}}</td>
                                                        <td>{{$files_type->name}}</td>
                                                        <td><a
                                                                href="{{route('filesmanger.index',array('file_type_id' => $files_type->id))}}">{{$files_type->count}}</a>
                                                        </td>
                                                        <td>
                                                            @role('filesTypes.update')
                                                            <a class="me-2" data-bs-toggle="modal"
                                                               href="{{('/#editModal'.$files_type->id)}}"><i
                                                                    data-toggle="modal"
                                                                    data-target="#editModal{{$files_type->id}}"
                                                                    data-feather="edit" width="15" height='15'></i>
                                                            </a>
                                                            @endrole
                                                            @role('filesTypes.destroy')
                                                            <form
                                                                action="{{ route('filesTypes.destroy',$files_type->id)}}"
                                                        ...
                                                        <div class="modal fade modal-bookmark"
                                                             id="editModal{{$files_type->id}}" tabindex="-1"
                                                             role="dialog"
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="form-bookmark needs-validation"
                                                                              action="{{route('filesTypes.update',$files_type->id)}}"
