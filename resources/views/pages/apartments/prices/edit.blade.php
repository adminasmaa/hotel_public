...
<div class="container-fluid">
    <div class="row">
        <form class="mega-vertical" action="{{route('prices.update',$price->id)}}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="d-flex mb-3">
                                <input type="radio" value="day" name="type"
                                    {{ old('type',$price->type) == 'day' ? 'checked' : ''}} />
                                السعر حسب اليوم
                            </div>
                            <div class="d-flex mb-3">
                                <input type="radio" value="week" name="type"
                                    {{old('type',$price->type)=="week"?"checked":""}} /> السعر
                                حسب الاسبوع
                            </div>
                            <input class="form-control" type="hidden" name="apart_id" value="12">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="prices[]"
                                                    value="{{old('prices.0',$price->prices[0]['price'])}}">
                                                @error('prices.0')
                                                <div style='color:red'>{{$message}}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="prices[]"
                                                    value="{{old('prices.1',$price->prices[1]['price'])}}">
                                                @error('prices.1')
                                                <div style='color:red'>{{$message}}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="prices[]"
                                                    value="{{old('prices.2',$price->prices[2]['price'])}}">
                                                @error('prices.2')
                                                <div style='color:red'>{{$message}}</div>
                                                @enderror
                                            </div>
