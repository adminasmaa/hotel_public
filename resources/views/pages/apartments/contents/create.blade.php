...
@section('content')
    <div class="container-fluid" style="background: #f4f4f4;">
        <div class="row">
            <form class="mega-vertical" action="{{route('contents.store')}}" method="post"
                    ...
                    <div class="card height-equal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="apartment_id" value="{{request()->get('apart')}}"/>
                                <input type="hidden" name="home_content_id" value="{{request()->has('content')?request()->get('content'):App\Models\Apartment\HomeContent::first()->id}}"/>
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            ...
                                            <select class="form-select digits" id="exampleFormControlSelect9" name="type" value="{{old('type')}}">
                                                        ...
                                                        <option value='main' >اساسى</option>
