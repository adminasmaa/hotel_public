...
@section('title', ' تعدبل التزام ')

@section('content')
    <div class="container-fluid" style="background: #f4f4f4;">
        <div class="row">
            <form class="mega-vertical" action="{{route('commitments.update',$commitment->id)}}" method="post"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <select class="form-select digits choosetype"  id="exampleFormControlSelect9" name="section_id">
                                                        ...
                                                        @foreach($CommitmentSections as $section)  
                                                          <option value='{{$section->id}}' {{$commitment->section_id==$section->id?'selected':''}}>{{$section->name}}</option>
                                                        @endforeach                            
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tel" class="mobileNumber form-control" maxlength="20"
                                                       id="lb_phone" value="{{optional($commitment->country)->code}}{{$commitment->phone}}" name="phone" title="">
                                                @error('phone')
                                                <div style='color:red'>{{$message}}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            <label class="col-sm-12 col-form-label">المبلغ<span
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="number" name='value' value="{{$commitment->value}}" title="">
                                                    @error('value')
                                                    <div style='color:red'>{{$message}}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            <label class="col-sm-12 col-form-label">رقم الحساب<span
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="number" name='account_num' value="{{$commitment->account_num}}" title="">
                                                    @error('account_num')
                                                    <div style='color:red'>{{$message}}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            <label class="col-sm-12 col-form-label">الحاله<span
                                                ...
                                                <div class="col-sm-9">
                                                    <div>
                                                        <input type="radio" name='status'  value="work" class="" {{$commitment->status=='work'?'checked':''}} placeholder="">يعمل
                                                        <input type="radio" name='status'  value="notWork" class="" {{$commitment->status=='notWork'?'checked':''}} placeholder=""> متوقف
