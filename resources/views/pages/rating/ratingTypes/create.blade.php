...
<div class="container-fluid">
          <div class="row">
          <form class="mega-vertical" action="{{route('rating_types.store')}}" method="post"
                  enctype="multipart/form-data">
                @csrf
              <div class="col-sm-12 col-xxl-12 box-col-12 p-20">
                <div class="card height-equal">
                  <div class="card-header">
                      <h5>إضافة نوع جديد </h5>
                  </div>
                  <div class="card-body">
                    <div class="row">       
                      ...
                      <div class="col-sm-6">
                        <div class="media-body">
                          <div class="mb-3 row">
                            <label class="col-sm-12 col-form-label"> أدخل النوع  <span  class=" text-danger">*</span></label>
                            <div class="col-sm-9">
                              <input class="form-control" rows="3" name="name" >
                            </div>
                          </div>
                        </div>
                      </div>
