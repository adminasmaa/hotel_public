                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> @if($booking->status==1)
                                                            ...
                                                            <form action="{{ route('bookings.changeStatus', $booking->id) }}"
                                                                method="POST" class="d-inline">
                                                              
                                                                @csrf
                                                                <button  style="display: inline-block;border: none;background: none;"
                                                                type="submit" data-toggle="tooltip" data-placement="top" title="الدفع"                                                    
                                                        ...
                                                        <td class="not-export-col">
                                                            ...
                                                            <form action="{{ route('bookings.changeCase', $booking->id) }}"
                                                                method="POST" class="d-inline">
                                                              
                                                                @csrf
                                                                <button  style="display: inline-block;border: none;background: none;"
                                                                type="submit" data-toggle="tooltip" data-placement="top" title="الغاء"
                                                                onclick="return confirm('هل انت متاكد من الغاء الحاله');"                                                    
                                                                    class="btn btn-danger">الغاء
                                                                </button>
                                                            </form>
                                                            <!-- <button class="m" data-id="{{$booking->id}}"data-id=>الغاء</button> -->
