    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                <form class="mega-vertical" action="{{route('loans.update',$loan->id)}}" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" name="name" id="name" value="{{$loan->name}}"
                                               type="text"
                                               autocomplete="off">
                                        @error('name')
                                        <div style='color:red'>{{$message}}</div>
                                                ...
                                                <div class="col-sm-11">
                                                    <select name='branch_id' class="form-select"
                                                        ...
                                                        @foreach($branches_main as $branche_main)
                                                            <option
                                                                value='{{$branche_main->id}}'{{$loan->branch_id == $branche_main->id ?'selected':''}}>{{$branche_main->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('branch_id')
                                                    <div style='color:red'>{{$message}}</div>
                                            ...
                                            <div class="col-sm-11">
                                                <select name='loan_branch_id' class="form-select"
                                                    ...
                                                    @foreach($branches as $branche)
                                                        <option
                                                            value='{{$branche->id}}' {{$branche->id==$loan->loan_branch_id?'selected':''}}>{{$branche->name}}</option>
                                                    @endforeach
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" type="text" readonly name='loan_amount'
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" readonly name="pay_amount"
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" name="loan_date" id="loan_date"
                                               type="date" value="{{$loan->loan_date}}"
                                               autocomplete="off">
                                        @error('loan_date')
                                        <div style='color:red'>{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" name="installment_data" id="installment_data"
                                               type="date" value="{{$loan->installment_data}}"
                                               autocomplete="off">
                                    ...
                                    <div class="mb-3 mt-0 col-md-4">
                                        ...
                                        <input class="form-control" name="pay_type" value="{{$loan->pay_type}}"
                                               id="pay_type"
                                               type="text"
                                               autocomplete="off">
                                        @error('pay_type')
