...
@section('title', 'الانواع الفرعيه للفاتورة')
@section('content')
                ...
                <div class="card email-body radius-left">
                    <div class="ps-0">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="billsSubTypes" role="tabpanel"
                                 aria-labelledby="billsSubTypes-tab">
                                <div class="card mb-0">
                                    <div class="card-header d-flex">
                                        <h5 class="mb-0">


                                            @role('billsSubTypes.store')
                                            <button class="me-2 btn-block btn-mail w-100" data-bs-toggle="modal"
                                                    data-bs-target="#billsSubTypesModal" type="button"
                                        ...
                                        <div class="modal fade modal-bookmark" id="billsSubTypesModal" tabindex="-1"
                                             role="dialog" aria-labelledby="billsSubTypesModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="billsSubTypesModalLabel"> نوع فرعى 
                                                            جديد </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-bookmark needs-validation"
                                                              action="{{route('billsSubTypes.store')}}" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="dt-ext table-responsive">
                                            <table class=" table display  data-table-responsive " id="billsSubTypes">
                                                <thead>
                                                <tr>
                                                    <th>م</th>
                                                    <th> اسم </th>
                                                ...
                                                @php
                                                    $count=0;
                                                @endphp
                                                @foreach($billsSubTypes as $billsSubType)
                                                    @php $count=$count+1 @endphp
                                                    <tr>
                                                        <td>{{$count}}</td>
                                                        <td>{{$billsSubType->name}}</td>
                                                        <td>
                                                            @role('billsSubTypes.update')
                                                            <a class="me-2" data-bs-toggle="modal"
                                                               href="{{('/#editModal'.$billsSubType->id)}}"><i
                                                                    data-toggle="modal"
                                                                    data-target="#editModal{{$billsSubType->id}}"
                                                                    data-feather="edit" width="15" height='15'></i></a>
                                                            @endrole
                                                            @role('billsSubTypes.destroy') 
                                                            <form
                                                                action="{{ route('billsSubTypes.destroy', $billsSubType->id) }}"
                                                        ...
                                                        <div class="modal fade modal-bookmark"
                                                             id="editModal{{$billsSubType->id}}" tabindex="-1"
                                                             role="dialog"
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form class="form-bookmark needs-validation"
                                                                              action="{{route('billsSubTypes.update',$billsSubType->id)}}"
