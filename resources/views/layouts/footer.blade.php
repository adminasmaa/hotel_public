<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 footer-copyright text-center">
                <a href="https://mynewhotels.net/docs/index.php" target="_blank" class="btn btn-info" style="color:#000;background-color: #fff;"><i class="flaticon2-help"></i>  دليل المساعدة لشرح البرنامج </a>
            </div>
        </div>
    </div>
</footer>
...
<script>
    ...
    $('.modal-bookmark').on('hidden.bs.modal', function () {
      ...
      // set session  with branch_id  for branch and user not admin login
